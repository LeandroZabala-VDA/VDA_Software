...
from wsclient import WebSocketClient, WebSocketClientThread
...
class MainApp(QtWidgets.QMainWindow, Ui_MainWindow):
    def __init__(self):
        ...
        self.websocket_thread = WebSocketClientThread(self.websocket_client)
        ...
        while ser.in_waiting > 0:
            ...
            for value in new_frames:
                ...
                if self.acquiring:
                    ...
                    self.websocket_thread.send_update(str(value))  # Enviar el valor por WebSocket
                if len(buffer) >= 5:
                    data.extend(buffer)
                    buffer.clear()
